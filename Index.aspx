        ...
        <div id="header">
              <div id="header_first">
                <div class="header__in4">
                    ...
                    <marquee behavior="" direction="" width="100%"  >Nhóm Nông Hải Quý, Khuất Quang Duy Quý, Lưu Đắc Quyết bài tập lớn web giáo viên hướng dẫn Lê Hữu Dũng</marquee>
                </div>
                  ...
                  <div id="PhuKien">
                    ...
                    <div class="ContainerLaptop">
                      ...
                      <%--<div class="groupLapTop xemthemLap"  >
                            <a class="openLoiHethong"  style="color: rgb(37, 105, 195); font-size: 2rem; " >XEM THÊM</a>
                      </div>--%>
               ...
               <label id="online" runat="server" style="margin-left:48%;">Số lượt truy cập</label>
                ...
                <div class="containerFooter row">   <!-- Ô chứa hàng row -->
                  ...
                  <div class="footer__Info col c-4 m-12">
                    ...
                    <p class="footer__des">
                      Đây là bài tập lớn web cơ bản của 3 sinh viên Nông Hải Quý, Khuất Quang Duy Quý, Lưu Đắc Quyết. Bài tập lớn được hướng dẫn bởi giảng viên Lê Hữu Dũng
                    </p>
